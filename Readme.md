...
This project predicts whether a loan application should be approved or rejected based on applicant details using Machine Learning techniques.
...
6\. Run the notebook or training script.
